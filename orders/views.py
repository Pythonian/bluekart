...
def confirm_order(request):
    ...
    paystack_redirect_url = "{}?amount={}".format(
        reverse("paystack:verify_payment", args=[paystack_ref]), paystack_amount, order
    )
...
def order_status_shipped(request, id):
    ...
    messages.success(request, "Order status changed to: Shipped")
...
def order_status_processing(request, id):
    ...
    messages.success(request, "Order status changed to: Processing")
    return redirect(current_url)
